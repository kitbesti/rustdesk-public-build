...
impl AomEncoder {
    pub fn encode<'a>(
        ...
        let flags = if self.force_key_frame {
            self.force_key_frame = false;
            AOM_EFLAG_FORCE_KF as aom_enc_frame_flags_t
        } else {
            0
        };
    ...
    fn calc_q_values(ratio: f32) -> (u32, u32) {
        ...
        let q_min1 = 24;
        // The floor "Best" reaches: index 8 of 255, fine enough that text reads as
        // drawn; 0 would be lossless coding and frames of a size no budget allows.
        let q_min2 = 2;
        let q_max1 = 45;
        let q_max2 = 25;
