...
abstract class Rustdesk {
  ...
  FlutterRustBridgeTaskConstMeta get kCmCloseConnectionWindowConstMeta;
...
class RustdeskImpl implements Rustdesk {
  ...
  Future<void> cmCloseConnectionWindow({required int connId, dynamic hint}) {
    ...
    return _platform.executeNormal(FlutterRustBridgeTask(
      callFfi: (port_) =>
          _platform.inner.wire_cm_close_connection_window(port_, arg0),
      parseSuccessData: _wire2api_unit,
      constMeta: kCmCloseConnectionWindowConstMeta,
      argValues: [connId],
      hint: hint,
    ));
  }
  ...
  FlutterRustBridgeTaskConstMeta get kCmCloseConnectionWindowConstMeta =>
      const FlutterRustBridgeTaskConstMeta(
        debugName: "cm_close_connection_window",
        argNames: ["connId"],
      );
...
class RustdeskWire implements FlutterRustBridgeWireBase {
  ...
  void wire_cm_close_connection_window(
    int port_,
    int conn_id,
  ) {
    return _wire_cm_close_connection_window(
      port_,
      conn_id,
    );
  }
  ...
  late final _wire_cm_close_connection_window =
      _wire_cm_close_connection_windowPtr.asFunction<void Function(int, int)>();
...
const int VIDEO_QUEUE_SIZE = 30;

const int FIXED_CUSTOM_FPS = 120;
